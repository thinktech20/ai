...
METADATA_TABLE_DDL_COLS = """
    ...
    pdf_name            STRING                  COMMENT 'Human-readable filename derived from fsr_pdf_ref.PDF_name (nullable for manual files)',
...
CHUNK_TABLE_DDL_COLS = """
    chunk_id            STRING      NOT NULL    COMMENT 'document_id + chunk_index hash',
    document_id         STRING      NOT NULL    COMMENT 'FK to metadata registry (UUID stem)',
    pdf_name            STRING                  COMMENT 'Human-readable filename materialized from metadata registry',
    ...
    equipment_sys_id    STRING                  COMMENT 'Materialized from metadata registry',
    ...
    ev_equipment_event_id STRING                COMMENT 'Materialized from metadata registry',
    fsp_project_id      STRING                  COMMENT 'Materialized from metadata registry',
    report_issued_date  STRING                  COMMENT 'Materialized from metadata registry',
    outage_start_date   STRING                  COMMENT 'Materialized from metadata registry',
    outage_end_date     STRING                  COMMENT 'Materialized from metadata registry',
